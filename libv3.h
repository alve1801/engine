...
enum SDL_SCODE{ // shorter, more convenient aliases for SDL_SCANCODE
	KA=4,KB,KC,KD,KE,KF,KG,KH,KI,KJ,KK,KL,KM, // from the table by sam lantinga
	KN,KO,KP,KQ,KR,KS,KT,KU,KV,KW,KX,KY,KZ, K1,K2,K3,K4,K5,K6,K7,K8,K9,K0,
	KRET,KESC,KBKSP,KTAB,KSPC, KMINUS,KPLUS,KEQ=KPLUS,KLBR,KRBR,
	KBKSLASH,KWHATEVER,KSEMICOLON,KAPOST,KGRAVE,KCOMMA,KDOT,KSLASH,KCAPSLOCK,
	KFN0,KFN1,KFN2,KFN3,KFN4,KFN5,KFN6,KFN7,KFN8,KFN9,KFN10,KFN11,KFN12,
	KHOME=74,KPGUP,KDEL,KEND,KPGDN,KRIGHT,KLEFT,KDOWN,KUP,
	KFN13=104,KFN14,KFN15,KFN16,KFN17,KFN18,KFN19,KFN20,KFN21,KFN22,KFN23,KFN24,
	KCTRL=224,KSHIFT,KALT, KRCTRL=228,KRSHIFT,KRALT};
